...
public class DeleteProductCategoryCommandHandler : DirtyCommandHandler<ProductCategoryEntity, DeleteProductCategoryCommand, Result<ProductCategoryRecord>>
{
    ...
    private readonly IValidator<DeleteProductCategoryCommand> _validator;
    ...
    public DeleteProductCategoryCommandHandler(
        ...
        IMapper mapper,
        IValidator<DeleteProductCategoryCommand> validator,
        ILogger<DeleteProductCategoryCommandHandler> logger) : base(eventRepository, ProductCategoryUpdateConfig.Value, daprService, logger)
    {
    ...
    public override async Task<Result<ProductCategoryRecord>> Handle(DeleteProductCategoryCommand command, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                var evtPayload = new DeleteProductCategory(command.Id);
    ...
    private static string FailedToCreateMessage(DeleteProductCategoryCommand command) =>
